...
The tidy data sets use a subset of the 561 variables measured in the original dataset.  The complete set of variables are described in the original dataset (`./UCI HAR Dataset/features_info.txt`).  The following descriptions are a quote from that document:
